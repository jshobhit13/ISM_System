...
### Database Setup
![DB Setup](screenshots/db_setup.png)

### Live Dashboard
![Dashboard](screenshots/dashboard_charts.png)

### Live Readings
![Live Readings](screenshots/live_readings.png)

### Alert Triggered
![Alert](screenshots/alert_row.png)
...
```bash
git clone https://github.com/jshobhit13/ISM_System.git
cd ISM_System
...
`config.py` is gitignored. Use `.env.example` as a template — never commit real credentials.
